...
ggplot(all_seeded) +
         aes(x = nonnative_cover, y = native_cover, color = seeding) +
  geom_smooth(method = "lm", formula = y~x) +
...
N_thesis <- lm(native_cover ~ thatch_cover + nonnative_cover + seeding + thatch_cover:nonnative_cover + thatch_cover:seeding + nonnative_cover:seeding, data = all_seeded)
plot(N_thesis)
car::vif(N_thesis)
summary(N_thesis)
