...
nativecover_aov <- aov(native_cover ~ weeding * seeding, data = veg_data_clean)
...
leveneTest(native_cover ~ weeding * seeding, veg_data_clean)
...
nonnativecover_aov <- aov(nonnative_cover ~ weeding * seeding, data = veg_data_clean)
...
leveneTest(nonnative_cover ~ weeding * seeding, veg_data_clean)

# significant, variances are not equal, p = 0.0009

TukeyHSD(nonnativecover_aov, conf.level = 0.95)
